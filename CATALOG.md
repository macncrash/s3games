...
One thousand cartridges on the S3-16. A title is not approved until its packet is in `packets/<slug>/` and Avery accepts it. It is signed only after that, once Pit's `--sim` exits 0. The lead named here is the only person who may code it.
...
| # | Slug | Lead | State | Game |
|---|---|---|---|---|
| 001 | s3garally | House | shipped | Four-stage rally. Already on the console. |
| 002 | s3baron | Reed | refused | Western Front. Five waves, then the red triplane. `--sim` clears the circus. Avery has not signed it. |
| 003 | s3trap | Gale | open | Land the Hook. The boat is an `_OK_` 3-wire. Canyon ledge is OK. Rooftop, flatcar, and highway still fail the autopilot. |
| 004 | s3pins | Nock | complete | Ten frames. Knock them down. A mark finishes the game. |
| 005 | s3tank | Reed | complete | One street, two tanks. The one still moving takes the block. |
| 006 | s3keel | Gale | complete | Sail a triangle of buoys and come back to the same dock. |
| 007 | s3putt | Nock | complete | Nine short holes. Only the cup counts. |
| 008 | s3fort | Reed | complete | Hold the gate until the clock dies. |
| 009 | s3ski | Gale | complete | Gates on a downhill. Miss three and the run is over. |
| 010 | s3dart | Nock | complete | Five-oh-one, double out. The board is the whole game. |
| 011 | s3clay | Reed | complete | Twenty-five birds. The last five are the match. |
| 012 | s3rail | Gale | complete | A cab, a line, stop boxes. A late arrival costs the run. |
| 013 | s3curl | Nock | complete | Four ends. Closest to the button takes the end. |
| 014 | s3raid | Reed | complete | Ride the road into the yard and clear it. |
| 015 | s3kart | Gale | complete | Eight laps of one oval. Finish ahead of the pack. |
| 016 | s3eight | Nock | complete | One rack. Call the pocket. |
| 017 | s3mine | Reed | complete | A cart in a tunnel. Shoot the props, miss the walls. |
| 018 | s3tug | Gale | complete | Berth the ship. The pilings are a fail. |
| 019 | s3fair | Nock | complete | Three booths. Leave with a score. |
| 020 | s3blitz | Reed | complete | A trench run. Ammunition is the clock. |
| 021 | s3metro | Gale | complete | Stop in the box. Overshoot is a fail. |
| 022 | s3hoop | Nock | complete | First to twenty-one. The rim is the judge. |
| 023 | s3yard | Reed | complete | Junkyard. Last machine still running takes the purse. |
| 024 | s3heli | Gale | complete | Three pads. Land. Do not hover the clock out. |
| 025 | s3fish | Nock | complete | Daylight is the clock. Five keepers. |
| 026 | s3siege | Reed | complete | You are the wall. Stop the rams before the gate breaks. |
| 027 | s3sled | Gale | complete | One snow run. The clock is the other sled. |
| 028 | s3golf | Nock | complete | Three holes. In the hole, not on the green. |
| 029 | s3duel | Reed | complete | Three paces. Fire early and you lose. |
| 030 | s3bus | Gale | complete | Six stops. The doors open only in the box. |
| 031 | s3wicket | Nock | complete | Six balls. Hit the wicket or clear the rope. |
| 032 | s3convoy | Reed | complete | The truck has to arrive. Lose it and the road ends. |
| 033 | s3ferry | Gale | complete | Dock in the slip before the tide clock. |
| 034 | s3maze | Nock | complete | A hedge from the path. The exit is the only win. |
| 035 | s3rock | Reed | complete | A minute of rocks. The hull is the score. |
| 036 | s3plow | Gale | complete | Clear the pass before the storm clock hits zero. |
| 037 | s3chef | Nock | complete | Ten tickets. Plate them before they burn. |
| 038 | s3amber | Reed | complete | One intersection. Stop the ones who run it. Spare the ones who don't. |
| 039 | s3crane | Gale | complete | Three crates, ship to mark. A drop fails the shift. |
| 040 | s3table | Nock | complete | First to seven. The puck has to cross. |
| 041 | s3outpost | Reed | complete | Flares show them. Last until the dawn mark. |
| 042 | s3drift | Gale | complete | One pass. Score the slide. The wall ends it. |
| 043 | s3arch | Nock | complete | Thirty-six arrows. Gold counts double. |
| 044 | s3harbor | Reed | complete | One channel. The forts shoot back. The magazine is finite. |
| 045 | s3orbit | Gale | complete | Dock to the arm. Too hard a contact is a fail. |
| 046 | s3skate | Nock | complete | Land the line. A fall zeros the run. |
| 047 | s3keep | Reed | complete | The door, for three minutes. |
| 048 | s3bike | Gale | complete | One kilometer. Don't touch wheels. |
| 049 | s3bocce | Nock | complete | First to seven. Closest to the little ball. |
| 050 | s3flak | Reed | complete | The deck, the sky, a finite magazine. |
| 051 | s3sub | Gale | complete | A dark channel. Don't scrape the bottom. |
| 052 | s3market | Nock | complete | One stall. Right change. The line has to move. |
| 053 | s3ridge | Reed | complete | They come over the crest. Hold the path. |
| 054 | s3glider | Gale | complete | Ridge lift. Land in the field, not the trees. |
| 055 | s3shuffle | Nock | complete | First to fifteen. The disk has to stop in the score. |
| 056 | s3lot | Reed | complete | Three targets, then the gate, before the clock. |
...
| 076 | s3memory | Nock | complete | Match the table before the clock. |
...
| 107 | s3gatebann | Reed | complete | One gate. Bring the banner back. Then it is done. |
...
| 147 | s3glidergrass | Gale | complete | Take the glider and land on the grass and come to a full stop. The clock is the other crew. |
...
| 159 | s3gliderboom | Gale | complete | The glider has one job: deliver the drive to the boom. |
...
| 183 | s3tugboatgrass | Gale | complete | The tugboat has one job: land on the grass and come to a full stop. |
...
| 195 | s3tugboatboom | Gale | complete | In the tugboat, you deliver the drive to the boom. Missing the end fails the leg. |
...
| 215 | s3yardbann | Reed | complete | One yard. Bring the banner back. Then it is done. |
| 216 | s3sledlock | Gale | complete | The sled has one job: pass the lock without scraping a gate. |
| 217 | s3hoopseven | Nock | complete | A short hoop. You are done when first to seven. |
| 218 | s3yardpurs | Reed | complete | At the yard, you be the last machine still running. Miss that and the watch is over. |
| 219 | s3sledgrass | Gale | queued | In the sled, you land on the grass and come to a full stop. Missing the end fails the leg. |
| 220 | s3hoopbell | Nock | queued | Play hoop until the bell rings before the third try dies. Leave when that is true. |
| 221 | s3yardwell | Reed | queued | You have the yard. The job is to keep the well standing through three waves. Anything else is a loss. |
| 222 | s3sledkilo | Gale | queued | Take the sled and finish the kilometer without touching wheels. The clock is the other crew. |
...
| 234 | s3sledplat | Gale | queued | The sled has one job: stop level with the platform. |
...
| 250 | s3mazegold | Nock | queued | Play maze until only the gold counts double. Leave when that is true. |
...
| 306 | s3cabplat | Gale | queued | Take the cab and stop level with the platform. The clock is the other crew. |
...
| 358 | s3marketgold | Nock | queued | Play market until only the gold counts double. Leave when that is true. |
...
| 394 | s3keysgold | Nock | queued | A short keys. You are done when only the gold counts double. |
...
| 418 | s3jugglebell | Nock | queued | A short juggle. You are done when the bell rings before the third try dies. |
...
| 450 | s3lugeplat | Gale | queued | The luge has one job: stop level with the platform. |
...
| 562 | s3strikerbell | Nock | queued | Striker: the bell rings before the third try dies. That is the whole cartridge. |
...
| 586 | s3choirtape | Nock | queued | Choir: the drawer has to match the tape. That is the whole cartridge. |
...
| 598 | s3shelvebell | Nock | queued | Play shelve until the bell rings before the third try dies. Leave when that is true. |
...
| 650 | s3cisternpurs | Reed | queued | At the cistern, you be the last machine still running. Miss that and the watch is over. |
...
| 738 | s3subplat | Gale | queued | Take the sub and stop level with the platform. The clock is the other crew. |
...
| 750 | s3bikebuoy | Gale | queued | In the bike, you round the buoys and return to the same dock. Missing the end fails the leg. |
...
| 770 | s3trenchdawn | Reed | queued | You have the trench. The job is to keep the flares lit until dawn. Anything else is a loss. |
...
| 806 | s3wharfdawn | Reed | queued | One wharf. Keep the flares lit until dawn. Then it is done. |
...
| 838 | s3cuetape | Nock | queued | Play cue until the drawer has to match the tape. Leave when that is true. |
...
| 854 | s3foundrycler | Reed | queued | You have the foundry. The job is to clear the ground before the clock dies. Anything else is a loss. |
...
| 874 | s3tiletape | Nock | queued | A short tile. You are done when the drawer has to match the tape. |
...
| 926 | s3beaconcler | Reed | queued | At the beacon, you clear the ground before the clock dies. Miss that and the watch is over. |
...
| 938 | s3sallypurs | Reed | queued | One sally. Be the last machine still running. Then it is done. |
...
| 958 | s3maskbell | Nock | queued | A short mask. You are done when the bell rings before the third try dies. |
...
| 978 | s3metrokilo | Gale | queued | Take the metro and finish the kilometer without touching wheels. The clock is the other crew. |
