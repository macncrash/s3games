// S3 SKIFF GRASS — land on the grass and come to a full stop at the end.
// Missing that end fails the leg.
#pragma once
#include "art.h"
...
public:
    const char* title() const override { return "S3 SKIFF GRASS"; }
    ...
    // 0 title, 1 water, 2 on the grass, 3 in the end, 4 finished
    int marker() const;
