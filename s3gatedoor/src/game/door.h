// S3 GATE DOOR — one gate. Hold the door for three minutes.
#pragma once
...
public:
    const char* title() const override { return "S3 GATE DOOR"; }
...
private:
    ...
    void toTitle();
    void schedule();
    int upcoming(int kind) const;
    Intent intent(bool ramHit);
    void update();
    void fanfare();
    void serviceAudio();
