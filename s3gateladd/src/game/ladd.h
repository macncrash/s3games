// S3 GATE LADD — you have the gate. Reach the far ladder. Anything else is a loss.
#pragma once
#include <vector>
...
public:
    const char* title() const override { return "S3 GATE LADD"; }
    ...
    // 0 title, 1 the near wall, 2 the far tower, 3 ended
    int marker() const;
...
private:
    ...
    bool besideRungs() const;
    float grateDrop() const;
